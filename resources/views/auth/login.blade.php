...
@section('content')
    <div class="container-fluid p-0 h-100 overflow-hidden">
        <div class="row g-0 h-100">
            <div class="col-md-6 order-2 order-md-1 min-vh-100">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="text-center mb-4">
                                <img src="{{ asset('images/logoceopag.png') }}" height="48" alt="Logo CeoPag"
                                     class="mb-3">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="small text-decoration-none">Esqueceu
                                            sua senha?</a>
                                    @endif
                                </div>
